...
Generated by `experiments/run_cf_eval.py` at 2026-08-26T12:55:51+00:00, 100 cases per age group.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| FoodSense-DE | 32% | **32%** | 100% | **0%** | **0%** | 0.651 | 0.421 | 2.86 | 0.270 -> 0.636 | 2248 | 1.00 |
| Wachter (same space) | 14% | **14%** | 30% | **0%** | **70%** | 0.695 | 0.378 | 5.13 | 0.270 -> 0.249 | 2969 | 1.39 |
| Wachter-style | 14% | **4%** | 38% | **46%** | **62%** | 0.607 | 0.313 | 5.28 | 0.270 -> 0.274 | 2882 | 1.87 |
| DiCE-random | 41% | **24%** | 54% | **31%** | **46%** | 0.870 | 0.651 | 2.42 | 0.270 -> 0.388 | 3570 | 0.91 |
| DiCE-genetic | 2% | **2%** | 50% | **0%** | **50%** | 0.000 | 0.000 | 0.00 | 0.270 -> 0.270 | 6001 | 13.49 |
| Greedy | 43% | **30%** | 62% | **45%** | **38%** | 0.732 | 0.465 | 3.53 | 0.270 -> 0.476 | 489 | 0.16 |

### adult

| Method | Validity | **Usable validity** | Safe | Avail. viol. | Safety viol. | norm-L1 | norm-L2 | Sparsity | Score before -> after | Evals | Runtime (s) |
|---|---|---|---|---|---|---|---|---|---|---|---|
| FoodSense-DE | 30% | **30%** | 100% | **0%** | **0%** | 0.780 | 0.535 | 2.82 | 0.387 -> 0.616 | 1806 | 0.58 |
| Wachter (same space) | 54% | **54%** | 95% | **0%** | **5%** | 1.014 | 0.540 | 6.04 | 0.387 -> 0.677 | 2999 | 1.04 |
| Wachter-style | 50% | **12%** | 93% | **56%** | **7%** | 0.918 | 0.452 | 5.87 | 0.387 -> 0.637 | 2547 | 1.08 |
| DiCE-random | 49% | **21%** | 91% | **36%** | **9%** | 0.865 | 0.679 | 1.89 | 0.387 -> 0.526 | 3888 | 0.92 |
...
| Method | Validity | **Usable validity** | Safe | Avail. viol. | Safety viol. | norm-L1 | norm-L2 | Sparsity | Score before -> after | Evals | Runtime (s) |
|---|---|---|---|---|---|---|---|---|---|---|---|
| FoodSense-DE | 25% | **25%** | 100% | **0%** | **0%** | 0.956 | 0.621 | 3.42 | 0.285 -> 0.611 | 2225 | 0.91 |
| Wachter (same space) | 35% | **35%** | 71% | **0%** | **29%** | 1.073 | 0.598 | 6.17 | 0.285 -> 0.515 | 3201 | 1.35 |
| Wachter-style | 37% | **9%** | 72% | **59%** | **28%** | 1.015 | 0.508 | 6.31 | 0.285 -> 0.506 | 2941 | 1.65 |
| DiCE-random | 32% | **15%** | 78% | **20%** | **22%** | 0.739 | 0.551 | 1.55 | 0.285 -> 0.400 | 4526 | 1.01 |
| DiCE-genetic | 0% | **0%** | 76% | **0%** | **24%** | 0.000 | 0.000 | 0.00 | 0.285 -> 0.285 | 6001 | 12.20 |
| Greedy | 44% | **23%** | 73% | **54%** | **27%** | 1.026 | 0.585 | 4.16 | 0.285 -> 0.528 | 579 | 0.18 |

### All age groups pooled

| Method | Validity | **Usable validity** | Safe | Avail. viol. | Safety viol. | norm-L1 | norm-L2 | Sparsity | Score before -> after | Evals | Runtime (s) |
|---|---|---|---|---|---|---|---|---|---|---|---|
| FoodSense-DE | 29% | **29%** | 100% | **0%** | **0%** | 0.796 | 0.525 | 3.03 | 0.314 -> 0.621 | 2093 | 0.83 |
| Wachter (same space) | 34% | **34%** | 65% | **0%** | **35%** | 0.927 | 0.505 | 5.78 | 0.314 -> 0.480 | 3056 | 1.26 |
| Wachter-style | 34% | **8%** | 68% | **54%** | **32%** | 0.847 | 0.425 | 5.82 | 0.314 -> 0.472 | 2790 | 1.53 |
| DiCE-random | 41% | **20%** | 74% | **29%** | **26%** | 0.825 | 0.627 | 1.95 | 0.314 -> 0.438 | 3995 | 0.95 |
...
norm-L1 0.796 against 0.825-0.927 for the
...
| DiCE-random | `evaluation_budget_exhausted` | 125 |
